...
let myStyle = {
  color: props.mode === 'dark'?'white':'rgb(42 65 88)',
  backgroundColor: props.mode === 'dark'?'rgb(42 65 88)':'white'
}
  ...
  return (
    <div className="container" >
      <h1 className='my-3' style={{color: props.mode === 'dark' ? 'white' : 'rgb(42 65 88)',}}
      >About Us</h1>
      <div className="accordion" id="accordionExample"style={myStyle}>
        ...
        <div className="accordion-item">
          ...
          <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
            <div className="accordion-body" style={myStyle}>
              Textutiles is a free character counter toolthat provides instant character count &word count statistics for a given text. Textutiles reports the number of words and Characters. Thus it is suitable for writing text with word/ character limit. 
            </div>
          </div>
        </div>
        <div className="accordion-item">
